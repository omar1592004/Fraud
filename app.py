...
data_array = np.array([[amount, oldbalanceOrig, newbalanceOrig, ratio_to_median_purchase_price, used_chip, used_pin_number, online_order, distance_from_home,distance_from_last_transaction, fraud]])
